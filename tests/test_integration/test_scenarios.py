...
def test_scenario_1_buy_sell_realized_pnl():
    ...
    r = execute_order("005930", "SELL", 10, Decimal("80000"), ts=OPEN_KR)
...
def test_scenario_2_avg_cost_after_split_buys():
    execute_order("005930", "BUY", 10, Decimal("70000"), ts=OPEN_KR)
    execute_order("005930", "BUY", 30, Decimal("80000"), ts=OPEN_KR)
    pos = get_position("005930")
...
def test_scenario_3_usd_buy_with_fx():
    ...
    execute_order("AAPL", "BUY", 5, Decimal("200"), ts=OPEN_US_KST)
...
def test_scenario_4_kr_tax_020():
    execute_order("005930", "BUY", 10, Decimal("70000"), ts=OPEN_KR)
    r = execute_order("005930", "SELL", 10, Decimal("70000"), ts=OPEN_KR)
