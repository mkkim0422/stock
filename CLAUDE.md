...
| Phase | 내용 | 상태 |
|---|---|---|
| 1 | 골격 + 작동 가상투자 (fixtures) | 완료 |
| 2 | 실데이터 수집 + 환율 + 시장시간 + UI 차트 | 완료 |
| 3 | 시그널 엔진 (+8/-3 가중치) + 워치리스트 | 완료 |
| 4 | 백테스트 엔진 (워크포워드/OOS/메트릭) | 완료 |
| 5 | LLM 보조 (Gemini/Groq) | 완료 |
| 6 | 텔레그램 브리핑 (7회/일) | 완료 |
| 7 | GitHub Actions 자동 운영 + Streamlit Cloud | **완료** |
